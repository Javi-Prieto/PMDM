...
class PersonDetailsResponse {
  ...
  factory PersonDetailsResponse.fromMap(Map<String, dynamic> data) {
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [PersonDetailsResponse].
  factory PersonDetailsResponse.fromJson(String data) {
    return PersonDetailsResponse.fromMap(
        json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [PersonDetailsResponse] to a JSON string.
