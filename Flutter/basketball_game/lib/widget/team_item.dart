  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            Text(widget.teamName, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 65)),
            Container(
              decoration: const BoxDecoration(
              ),
              child: Text('$_puntuation', style:  TextStyle(color: widget.isBlack? Colors.orange: Colors.orange.shade600, fontSize: 65),),
            ),
            Row(
